                   ...
                   tabPanel("Graphique",fluidPage(),
                            ...
                            pageWithSidebar(headerPanel(''),
                                            sidebarPanel(
                                                ...
                                                conditionalPanel(condition="input.language == 1",radioButtons("bibli", "",choices = list("Bibliothèques nationales"=1,"Bibliothèques régionales, locales ou spécialisées"=2))),
