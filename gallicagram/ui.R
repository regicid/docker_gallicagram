                            ...
                            use_busy_spinner(spin = "fingerprint",position="full-page",color="#FF0000",spin_id = "ngram"),
                              div(id="Sidebar",column(4,wellPanel(
                                div(style="display: inline-block;vertical-align:top;",id="menumob2",actionButton("showSidebar2", "",icon = icon("bars"))),
                                                ...
                                                conditionalPanel(condition="input.doc_type==1 || input.doc_type==2 || input.doc_type==56 || input.doc_type==66 || input.doc_type==67 || input.doc_type==68 || input.doc_type==69 || input.doc_type==70 || input.doc_type==71 || input.doc_type==72 || input.doc_type==73 || input.doc_type==74 || input.doc_type==75 || input.doc_type==76",materialSwitch("contextualisation","Recherche du contexte",inline = T,status = 'success',value = T)),
