                   ...
                   tabPanel("Graphique",fluidPage(),
                            ...
                            pageWithSidebar(headerPanel(''),
                                            sidebarPanel(
                                                ...
                                                conditionalPanel(condition="input.doc_type == 2 && input.search_mode ==2",p('Recherche limitée à un seul syntagme dans 5 000 documents au maximum')),
                                                conditionalPanel(condition="(input.doc_type == 2 && input.search_mode ==2) || input.doc_type == 4",textOutput("avertissement")),
                                                ...
                                                selectInput("search_mode", "Mode de recherche",choices = list("Par document" = 1),selected = 1),
                                                ...
                                                conditionalPanel(condition="input.doc_type == 1 || input.doc_type == 3 || input.doc_type == 5 || (input.doc_type == 2 && input.search_mode == 1) || (input.doc_type == 4 && output.fileUploaded == 1 && output.avertissement.includes('Modifiez')==false) || (input.doc_type == 2 && input.search_mode == 2 && output.avertissement.includes('Modifiez')==false)",actionButton("do","Générer le graphique")),
                                                p(""),
