                   ...
                   tabPanel("Graphique",fluidPage(),
                            ...
                            pageWithSidebar(headerPanel(''),
                                            sidebarPanel(
                                                ...
                                                conditionalPanel(condition="input.doc_type != 4 && input.search_mode == 1",uiOutput("instructions")),
                                                ...
                                                selectInput("doc_type", "Corpus",choices = list("Presse / Gallica" = 1,"Recherche par titre de presse / Gallica" = 3, "Corpus personnalisé / Gallica"=4, "Livres / Gallica" = 2,"Livres / Ngram Viewer - Google Books" = 5, "Presse allemande / Europeana" = 6, "Presse néerlandaise / Europeana" = 7, "Presse britannique / BNA" = 8, "Livres / Ngram Viewer Allemand" = 9, "Livres / Ngram Viewer Anglais" = 10),selected = 1),
                                                div(style="display: inline-block;vertical-align:bottom;width: 45%;",selectInput("language", "Langue",choices = list("Français" = 1, "Allemand" = 2, "Néerlandais"=3, "Anglais"=4),selected = 1)),
