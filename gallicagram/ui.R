...
shinyUI(navbarPage("Gallicagram",
                   tabPanel("Graphique",fluidPage(),
                            ...
                            pageWithSidebar(headerPanel(''),
                                            sidebarPanel(
                                                div(style="display: inline-block;vertical-align:bottom;width: 79%;",textInput("mot","Recherche","Joffre&Pétain&Foch")),
                                                ...
                                                conditionalPanel(condition="input.doc_type == 3",uiOutput("themes_presse")),
                                                ...
                                                div(style="display: inline-block;vertical-align:bottom;width: 50%;",numericInput("beginning","Début",1914)),
                                                div(style="display: inline-block;vertical-align:bottom;width: 49%;",numericInput("end","Fin",1920)),
                                                radioButtons("resolution", label = "Résolution", choices = c("Année","Mois"),inline=T),
                                                conditionalPanel(condition="input.search_mode == 3 || input.doc_type == 1 || (input.doc_type == 3 && input.search_mode == 1) || input.doc_type == 5 || input.doc_type == 6 || input.doc_type == 7 || input.doc_type == 8 || input.doc_type == 9 || input.doc_type == 10 || input.doc_type == 11 || input.doc_type == 12 || input.doc_type == 13 || input.doc_type == 14 || input.doc_type == 15 || input.doc_type == 16 || input.doc_type == 17 || input.doc_type == 18 || input.doc_type == 19 || input.doc_type == 20 || input.doc_type == 21 || input.doc_type == 22 || input.doc_type == 23 || input.doc_type == 24 || input.doc_type == 25 || input.doc_type == 26 || input.doc_type == 27 || input.doc_type == 28 || input.doc_type == 29 || (input.doc_type == 2 && input.search_mode == 1) || (input.doc_type == 4 && output.fileUploaded == 1 && output.avertissement.includes('Modifiez')==false) || ((input.doc_type == 2 || (input.doc_type == 3  && input.titres.length <= 15)) && input.search_mode == 2 && output.avertissement.includes('Modifiez')==false)",actionButton("do","Générer le graphique")),
                                                p(""),
