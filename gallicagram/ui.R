                   ...
                   tabPanel("Graphique",fluidPage(),
                            ...
                            pageWithSidebar(headerPanel(''),
                                            sidebarPanel(
                                                ...
                                                conditionalPanel(condition="input.language == 1",radioButtons("bibli", "",choices = list("Gallica"=1,"Bibliothèques nationales"=2,"Bibliothèques régionales, locales ou spécialisées"=3,"Presse contemporaine"=4,"Corpus scientifiques"=5),inline = T)),
