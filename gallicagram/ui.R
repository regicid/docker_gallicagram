  ...
  navbarPage(id="#navbar",title=div(img(src="Logoo.png",
                   ...
                   tabPanel("Graphique",
                              ...
                              div(id="Sidebar",column(4,wellPanel(
                                div(style="display: inline-block;vertical-align:top;",id="menumob2",actionButton("showSidebar2", "",icon = icon("bars"))),
                                                ...
                                                div(style="display: inline-block;vertical-align:top;width: 49%;",selectInput("doc_type", "Corpus",choices = list("Presse française / Gallica" = 1,"Recherche par titre de presse / Gallica" = 3,
                                                                                                                                                                 ...
                                                                                                                                                                 "Le Temps (1861-1942)"=71,"Le Petit Journal (1863-1942)"=72,"Le Petit Parisien (1876-1944)"=73,
                                                                                                                                                                 "Le Journal Officiel (1869-1952)"=74,"Le Journal des Débats (1805-1944)"=75,"La Presse (1836-1930)"=76,
                                                                                                                                                                 "Opensubtitles / Films en français"=77, "Opensubtitles / Films en anglais"=78,
                                                                                                                                                                 "L'Orient-Le Jour"=79
                                                                                                                                                                 ),selected = 1)),
                                            ...
                                            div(column(8,rclipboardSetup(),
                                                      ...
                                                      div(id="article",style="display: inline-block;vertical-align:middle;float:right",actionButton("link", "Article de recherche",onclick ="window.open('https://osf.io/preprints/socarxiv/84bf3_v1/', '_blank')")),
                            ...
                            fluidRow(column(12,
                                   ...
                                   conditionalPanel(condition="input.contextualisation==true && (input.doc_type==1 || input.doc_type==2 || input.doc_type==56 || input.doc_type==66 || input.doc_type==67 || input.doc_type==68 || input.doc_type==69 || input.doc_type==70 || input.doc_type==71 || input.doc_type==72 || input.doc_type==73 || input.doc_type==74 || input.doc_type==75 || input.doc_type==76 || input.doc_type==81)",dataTableOutput("frame")),
                                   useShinyjs(),
